  ...
  return (
    <div className="flex min-h-[60vh] flex-1 flex-col items-center justify-center px-4 py-16">
      <div className="w-full max-w-md rounded-2xl border border-zinc-200 bg-white p-8 text-center shadow-sm">
        <p className="text-sm font-medium uppercase tracking-wide text-red-600">{t("errorLabel")}</p>
        <h1 className="mt-2 text-xl font-semibold tracking-tight text-zinc-900">{t("title")}</h1>
