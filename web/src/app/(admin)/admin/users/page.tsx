...
export default async function AdminUsersPage() {
  ...
  if (!result.ok) {
    return (
      <div className="rounded-xl border border-red-200 bg-red-50 p-6 text-red-900 dark:border-red-900 dark:bg-red-950/40 dark:text-red-100">
        ...
        <p className="mt-4 text-sm text-red-800/90 dark:text-red-200/80">{t("usersHint")}</p>
      </div>
    );
  }
  ...
  return (
    <div>
      ...
      <p className="mt-2 max-w-3xl text-sm text-zinc-600 dark:text-zinc-400">{t("usersIntro")}</p>
