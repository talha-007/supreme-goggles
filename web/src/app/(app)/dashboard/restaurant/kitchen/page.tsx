      ...
      <div className="mt-6 grid gap-3 sm:grid-cols-2">
        {orders.length === 0 ? (
          ...
          orders.map((o) => {
            ...
            return (
              <div key={o.id} className="rounded-xl border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-950">
                ...
                <div className="mt-3">
                  <QuickStatusButton invoiceId={o.id} nextStatus={next} label={cta} />
                </div>
              </div>
            );
          })
