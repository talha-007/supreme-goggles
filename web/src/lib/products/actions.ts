...
export async function createProduct(
  ...
  const { data: inserted, error } = await supabase
    ...
    .insert({
      ...
      alternate_part_numbers: String(formData.get("alternate_part_numbers") ?? "").trim() || null,
      application_notes: String(formData.get("application_notes") ?? "").trim() || null,
      ...
      expiry_date: parseNullableDate(formData.get("expiry_date")),
