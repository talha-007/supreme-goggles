    ...
    <div className="flex flex-col gap-6">
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="flex flex-col gap-1 sm:col-span-2">
          ...
          >
            <option value="">Optional â€” select later</option>
            {suppliers.map((s) => (
                ...
                <tr key={i}>
                  <td className="px-3 py-2">
                    <select
                      ...
                      className="w-full max-w-[200px] rounded border border-zinc-200 bg-white px-2 py-1 text-xs"
                    >
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 rounded-xl border border-zinc-200 bg-zinc-50 px-4 py-3">
        ...
        <div className="flex gap-2">
          ...
          >
            {pending ? "Savingâ€¦" : "Create draft PO"}
          </button>
        </div>
      </div>
