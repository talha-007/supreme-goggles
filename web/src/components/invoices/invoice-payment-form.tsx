...
export function InvoicePaymentForm({ invoiceId, balanceDue }: Props) {
  ...
  return (
    <form onSubmit={submit} className="flex flex-col gap-3 rounded-xl border border-zinc-200 bg-white p-4">
      <h3 className="text-sm font-semibold text-zinc-900">{tp("title")}</h3>
      <div className="grid gap-3 sm:grid-cols-2">
        ...
        <div className="flex flex-col gap-1">
          <label className="text-xs font-medium text-zinc-600">{tp("method")}</label>
          <select
            value={method}
