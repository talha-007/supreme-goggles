-- If invoice_items have no catalog product_id rows (or were cleared), the reverse loop did nothing
-- even when stock was deducted (stock_movements still show the sale). Restore from movements.
