-- Detect "we sold stock on this invoice" using any positive `out` movement for this
-- reference_id (not only reference_type = 'invoice'). Some rows may have null reference_type;
-- ignore bogus rows with quantity <= 0 (e.g. negative `out`).
